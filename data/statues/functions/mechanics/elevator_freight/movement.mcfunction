...
$execute if score $SoundTick Statues.TempData matches 0 positioned ~ ~$(elevator_location_cur) ~ run function statues:mechanics/elevator_freight/sound_tick
...
execute if score @s Statues.ElevatorState matches 4 run function statues:mechanics/elevator_freight/apply_collision_movement_relative with storage statues:data

execute if score @s Statues.ElevatorRemaining matches 0 run function statues:mechanics/elevator_freight/post_movement with storage statues:data
