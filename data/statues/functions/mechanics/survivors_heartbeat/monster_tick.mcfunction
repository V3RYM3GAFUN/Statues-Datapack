...
execute if entity @a[team=Survivor,tag=!hidden,distance=3.5..7.4999,sort=nearest,limit=1] if score @s Statues.Heartbeat matches ..0 run playsound minecraft:entity.warden.heartbeat master @s ~ ~ ~ 1 1.2
execute if score @s Statues.Heartbeat matches ..-1 run scoreboard players add @s Statues.Heartbeat 40
execute if score @s Statues.Heartbeat matches ..0 run scoreboard players set @s Statues.Heartbeat 0
...
execute if entity @a[team=Survivor,tag=!hidden,distance=0..3.4999,sort=nearest,limit=1] if score @s Statues.Heartbeat matches ..0 run playsound minecraft:entity.warden.heartbeat master @s ~ ~ ~ 1 1.4
execute if score @s Statues.Heartbeat matches ..-1 run scoreboard players add @s Statues.Heartbeat 40
execute if score @s Statues.Heartbeat matches ..0 run scoreboard players set @s Statues.Heartbeat 0
