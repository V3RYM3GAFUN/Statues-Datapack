...
$item replace entity @s hotbar.8 with compass{is_compass_tracker:1b,display:{Name:'{"text":"Objective Tracker","italic":false}'},LodestoneDimension:"minecraft:overworld",LodestonePos:{X:$(compass_target_pos_x),Y:$(compass_target_pos_y),Z:$(compass_target_pos_z)},LodestoneTracked:0b}
