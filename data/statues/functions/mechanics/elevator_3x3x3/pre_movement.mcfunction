...
$execute if score @s Statues.ElevatorState matches 4 run function statues:mechanics/elevator_3x3x3/apply_collision_movement_static {elevator_location: $(elevator_location), elevator_collision_y: "~-0.18"}
...
function statues:mechanics/elevator_3x3x3/apply_player_effects with storage statues:data
...
function statues:mechanics/elevator_3x3x3/apply_display_translation with storage statues:data
