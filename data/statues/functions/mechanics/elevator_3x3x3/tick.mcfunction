...
execute unless entity @s[tag=elevator_room_3x3x3_gencol] run function statues:mechanics/elevator_3x3x3/generate_collisions
...
execute if score @s Statues.ElevatorState matches 3..4 run function statues:mechanics/elevator_3x3x3/calculate_moving_location
...
function statues:mechanics/elevator_3x3x3/elevator_tick with storage statues:data
execute if score @s Statues.ElevatorState matches 1 run function statues:mechanics/elevator_3x3x3/pre_move with storage statues:data
execute if score @s Statues.ElevatorState matches 2 run function statues:mechanics/elevator_3x3x3/pre_movement with storage statues:data
execute if score @s Statues.ElevatorState matches 3..4 run function statues:mechanics/elevator_3x3x3/movement with storage statues:data
execute if score @s Statues.ElevatorState matches 5 run function statues:mechanics/elevator_3x3x3/post_move with storage statues:data
execute if score @s Statues.ElevatorState matches 6 run function statues:mechanics/elevator_3x3x3/cooldown
