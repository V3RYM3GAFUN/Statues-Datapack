...
execute unless entity @s[tag=elevator_room_2x3x2_gencol] run function statues:mechanics/elevator_2x3x2/generate_collisions
...
execute if score @s Statues.ElevatorState matches 3..4 run function statues:mechanics/elevator_2x3x2/calculate_moving_location
...
function statues:mechanics/elevator_2x3x2/elevator_tick with storage statues:data
execute if score @s Statues.ElevatorState matches 1 run function statues:mechanics/elevator_2x3x2/pre_move with storage statues:data
execute if score @s Statues.ElevatorState matches 2 run function statues:mechanics/elevator_2x3x2/pre_movement with storage statues:data
execute if score @s Statues.ElevatorState matches 3..4 run function statues:mechanics/elevator_2x3x2/movement with storage statues:data
execute if score @s Statues.ElevatorState matches 5 run function statues:mechanics/elevator_2x3x2/post_move with storage statues:data
execute if score @s Statues.ElevatorState matches 6 run function statues:mechanics/elevator_2x3x2/cooldown
