...
execute as @a[team=Lobby,tag=!queued] at @s if block ~ -64 ~ diamond_block run function statues:lobby/queue/queue_join
execute as @a[team=Lobby,tag=queued] at @s unless block ~ -64 ~ diamond_block unless block ~ -64 ~ gold_block run function statues:lobby/queue/queue_leave
execute as @a[team=!Lobby,tag=queued] run function statues:lobby/queue/queue_leave
