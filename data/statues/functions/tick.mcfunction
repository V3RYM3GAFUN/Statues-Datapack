...
execute if score $Status Statues.DynamicData matches 3 run function statues:ingame/gametimer
execute if score $Status Statues.DynamicData matches 3 run function statues:ingame/mechanics/misc

execute if score $Status Statues.DynamicData matches 3 if score dev_allow_debug_info Statues.FeatureFlags matches 0 run gamerule reducedDebugInfo true
...
execute as @a at @s if entity @e[tag=lobby_tutorial_tp,distance=..1.5] run function statues:lobby/tutorial-info/start 
