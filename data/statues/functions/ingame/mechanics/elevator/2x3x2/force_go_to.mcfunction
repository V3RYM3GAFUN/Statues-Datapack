...
function statues:ingame/mechanics/elevator/2x3x2/apply_collision_movement_align
execute store result storage statues:data elevator_location int 1 run scoreboard players get @s Statues.ElevatorFrom
function statues:ingame/mechanics/elevator/2x3x2/update_lights with storage statues:data
...
function statues:ingame/mechanics/elevator/2x3x2/post_movement with storage statues:data
