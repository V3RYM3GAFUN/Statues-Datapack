...
execute if score elevator_buttons Statues.FeatureFlags matches 1 as @e[type=minecraft:marker,tag=elevator_button] at @s run function statues:ingame/mechanics/elevator/buttons/tick with entity @s data
