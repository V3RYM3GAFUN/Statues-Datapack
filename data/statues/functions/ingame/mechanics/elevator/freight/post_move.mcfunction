...
$execute positioned ~ ~$(elevator_location_to) ~ as @e[tag=elevator_door,sort=nearest,limit=2,distance=..6] at @s align xyz positioned ~0.5 ~0.5 ~0.5 run function statues:ingame/mechanics/elevator/freight/door_open with entity @s data
