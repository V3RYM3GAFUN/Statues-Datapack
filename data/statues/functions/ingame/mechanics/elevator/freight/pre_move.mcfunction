...
execute if score @s Statues.ElevatorRemaining matches 0 run function statues:ingame/mechanics/elevator/freight/pre_move_first with storage statues:data
...
$execute positioned ~ ~$(elevator_location_to) ~ as @e[tag=elevator_door,sort=nearest,limit=2,distance=..6] at @s run function statues:ingame/mechanics/elevator/freight/door_close with entity @s data
