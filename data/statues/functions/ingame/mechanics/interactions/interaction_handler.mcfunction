...
execute if entity @s[tag=show] run function statues:ingame/mechanics/survivors/interactions/show
execute if entity @s[tag=hide] run function statues:lobby/tutorial-info/interactions/hide
execute if entity @s[tag=show] run function statues:lobby/tutorial-info/interactions/show
