...
execute as @e[tag=power_door_dz,tag=!power_door_opened] at @s run particle cloud ^ ^1 ^.0 0 0.75 1 0.05 50 normal
execute as @e[tag=power_door_dz,tag=!power_door_opened] at @s run playsound block.piston.contract block @a ~ ~.5 ~ 1 0.75
execute as @e[tag=power_door_dx,tag=!power_door_opened] at @s run particle cloud ^ ^1 ^.0 1 .75 0 0.05 50 normal
