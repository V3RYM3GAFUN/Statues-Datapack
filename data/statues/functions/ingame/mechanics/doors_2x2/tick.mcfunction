...
execute as @e[tag=doord_init,type=minecraft:block_display] run function statues:ingame/mechanics/doors_2x2/doord_tick_init
...
execute as @e[tag=door,tag=!door_generated] at @s run function statues:ingame/mechanics/doors_2x2/door_create_display
...
execute as @e[tag=door_anim_open,tag=!door_animating] at @s run function statues:ingame/mechanics/doors_2x2/door_anim_open
...
execute as @e[tag=door_anim_close] unless entity @s[scores={Statues.DoorData=-2147483648..2147483647}] at @s run function statues:ingame/mechanics/doors_2x2/door_anim_close
...
#execute as @e[type=#minecraft:impact_projectiles] at @s as @e[tag=door,tag=!door_opened,distance=..5] run function statues:ingame/mechanics/doors_2x2/tick_arrow

scoreboard players enable @a[team=Dev] check_integrity_doors
execute as @a[team=Dev,scores={check_integrity_doors=1..}] run function statues:ingame/mechanics/doors_2x2/integrity
