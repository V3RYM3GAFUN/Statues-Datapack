...
scoreboard players operation $SpectatorDistanceD10 Statues.TempData /= $100000 Statues.StaticData
scoreboard players operation $SpectatorDistanceM10 Statues.TempData = $PythagorasR Statues.TempData
scoreboard players operation $SpectatorDistanceM10 Statues.TempData /= $10000 Statues.StaticData
