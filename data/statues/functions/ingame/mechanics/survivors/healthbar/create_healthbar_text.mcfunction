...
execute if score survivors_heart_sidebar Statues.FeatureFlags matches 1.. run function statues:ingame/mechanics/survivors/healthbar/healthbar_update_normal
execute if score survivors_heart_sidebar Statues.FeatureFlags matches 1.. run function statues:ingame/mechanics/survivors/healthbar/healthbar_update_absorption
...
function statues:ingame/mechanics/survivors/healthbar/health_direct_number with storage statues:data
