...
#> Chase music
execute as @a[team=Survivor] at @s if score @s Statues.DynamicData matches 0..99 if entity @e[team=Monster,distance=..8] run scoreboard players add @s Statues.DynamicData 1
...
execute as @a[team=Survivor] at @s if entity @e[team=Monster,distance=8..] if score @s Statues.DynamicData matches 1.. run scoreboard players remove @s Statues.DynamicData 1
