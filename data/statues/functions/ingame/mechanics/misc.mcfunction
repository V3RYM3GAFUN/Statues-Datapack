...
execute as @e[type=item,nbt=!{Item:{tag:{objective_item:1b}}}] run function statues:ingame/mechanics/nodrop
...
execute as @e[type=item,nbt={Item:{tag:{objective_item:1b}}}] at @s run data modify entity @s Owner set from entity @p[team=Survivor] UUID
