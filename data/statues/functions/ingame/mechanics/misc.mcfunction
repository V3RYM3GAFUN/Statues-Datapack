...
execute as @a[team=Survivor] at @s run function statues:ingame/mechanics/survivors/leave_trail

execute as @e[tag=survivor_blood_trail] at @s run function statues:ingame/mechanics/monsters/trail_tick