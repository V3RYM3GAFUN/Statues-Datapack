...
execute if entity @s[tag=3x3door,tag=door3x3_opening,tag=!door3x3_opened] run function statues:ingame/mechanics/doors_3x3/open
execute if entity @s[tag=3x3door,tag=!door3x3_opening,tag=door3x3_opened] run function statues:ingame/mechanics/doors_3x3/close
