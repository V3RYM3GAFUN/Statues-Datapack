...
#> Armour and tools specific to 003
...
item replace entity @s weapon.mainhand with red_dye{display:{Name:'[{"text":"Boxing glove","italic":false,"color":"red","bold":true}]'}} 1
item replace entity @s weapon.offhand with red_dye{display:{Name:'[{"text":"Boxing glove","italic":false,"color":"red","bold":true}]'}} 1