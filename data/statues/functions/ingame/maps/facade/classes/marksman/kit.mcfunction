...
item replace entity @s hotbar.1 with tipped_arrow{CustomPotionColor:0,display:{Name:'[{"text":"Sniper ammo","italic":false,"color":"dark_gray","bold":true}]'},custom_potion_effects:[{id:"minecraft:slowness",duration:80,amplifier:2b,show_particles:0b},{id:"minecraft:glowing",duration:300,show_particles:0b}]} 16
