...
item replace entity @s hotbar.0 with crossbow{Unbreakable:1b,"display":{Name:'[{"text":"Medic pistol","italic":false}]'},CustomModelData:5,Enchantments:[{id:"quick_charge",lvl:5}]}
