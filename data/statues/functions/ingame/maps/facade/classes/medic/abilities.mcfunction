...
execute if score @s Statues.Players matches 6000 run effect give @a[team=Survivor] regeneration 10 2 true
execute if score @s Statues.Players matches 6000 run tellraw @a[team=Survivor] [{"selector":"@s"},{"text": " used healing nanobots on the team!"}]
...
function statues:ingame/mechanics/xp_bar/from_cooldown { max: 6000 }
