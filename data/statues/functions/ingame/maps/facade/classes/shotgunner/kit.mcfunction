...
item replace entity @s hotbar.0 with crossbow{Unbreakable:1,display:{Name:'[{"text":"Shotgun","italic":false}]'},Enchantments:[{id:"multishot",lvl:1}],HideFlags:1,CustomModelData:3}
item replace entity @s hotbar.1 with tipped_arrow{CustomPotionColor:568831,display:{Name:'[{"text":"Weak Anti-anomaly Ammo","italic":false,"color":"dark_aqua"}]'},custom_potion_effects:[{id:"minecraft:blindness",duration:40,show_particles:0b},{id:"minecraft:slowness",duration:60,amplifier:2,show_particles:0b}]} 32
