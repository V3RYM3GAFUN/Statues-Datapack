...
execute if score @s Statues.Players matches 1200..1800 unless data entity @s Inventory[{Slot:4b,id:"minecraft:shield"}] run item replace entity @s weapon with shield
