...
execute if score @s Statues.Abilities matches 1.. if score @s Statues.Players matches ..0 run effect give @s invisibility 15 0 true
...
execute if score @s Statues.Players matches 801..1200 run item replace entity @s armor.feet with air
execute if score @s Statues.Players matches 801..1200 run item replace entity @s armor.legs with air
execute if score @s Statues.Players matches 801..1200 run item replace entity @s armor.chest with air
execute if score @s Statues.Players matches 801..1200 run item replace entity @s armor.head with air
...
execute if score @s Statues.Players matches 800 run item replace entity @s armor.chest with leather_chestplate{display:{color:8991416,Name:'["",{"text":"Cloaker Outfit","italic":false,"color":"dark_purple","bold":true}]'},Unbreakable:1,HideFlags:68}
execute if score @s Statues.Players matches 800 run item replace entity @s armor.legs with leather_leggings{display:{color:8991416,Name:'["",{"text":"Cloaker Outfit","italic":false,"color":"dark_purple","bold":true}]'},Unbreakable:1,HideFlags:68}
execute if score @s Statues.Players matches 800 run item replace entity @s armor.feet with leather_boots{display:{color:8991416,Name:'["",{"text":"Cloaker Outfit","italic":false,"color":"dark_purple","bold":true}]'},Unbreakable:1,HideFlags:68}
execute if score @s Statues.Players matches 800 run item replace entity @s armor.head with player_head{display:{Name:'{"text":"Cloaker\'s helmet"}'},SkullOwner: {Id: [I; -1588096129, 470896178, -1736494308, -995102482], Properties: {textures: [{Value: "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvMjFmMzc0MTZlNTI1M2UzZjU0MGVlZTc4MTM3ZDBiNGI5ZThjOWY2YmFmNWRiNjQ2Y2Y5MDY5Y2ZkNGIyOGM0NSJ9fX0="}]}}}
