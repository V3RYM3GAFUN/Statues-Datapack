...
execute if score @s Statues.Players matches 1001..1200 run item replace entity @s armor.feet with air
execute if score @s Statues.Players matches 1001..1200 run item replace entity @s armor.legs with air
execute if score @s Statues.Players matches 1001..1200 run item replace entity @s armor.chest with air
execute if score @s Statues.Players matches 1001..1200 run item replace entity @s armor.head with air
...
execute if score @s Statues.Players matches 1000 run item replace entity @s armor.chest with leather_chestplate{display:{color:8991416,Name:'["",{"text":"Cloaker Outfit","italic":false,"color":"dark_purple","bold":true}]'},Unbreakable:1,HideFlags:68}
execute if score @s Statues.Players matches 1000 run item replace entity @s armor.legs with leather_leggings{display:{color:8991416,Name:'["",{"text":"Cloaker Outfit","italic":false,"color":"dark_purple","bold":true}]'},Unbreakable:1,HideFlags:68}
