...
execute if score @s Statues.Players matches ..3600 unless data entity @s Inventory[{Slot:4b,id:"minecraft:carrot_on_a_stick"}] run item replace entity @s hotbar.4 with carrot_on_a_stick{Unbreakable:1,CustomModelData:3,display:{Name:'[{"text":"Infinite ammo","italic":false,"color":"gray"}]',Lore:['[{"text":"Cooldown: 60 secs","italic":false}]']},HideFlags:4}
...
execute if score @s Statues.Players matches ..0 run item replace entity @s hotbar.4 with carrot_on_a_stick{Unbreakable:1b,CustomModelData:3,display:{Name:'[{"text":"Infinite ammo","italic":false,"color":"aqua"}]',Lore:['[{"text":"Cooldown: 3m","italic":false}]']},Enchantments:[{}],HideFlags:4}

#> Prevents the player from duplicating items
execute store result score $Arrows Statues.ItemCount run clear @s tipped_arrow{CustomPotionColor:568831,display:{Name:'[{"text":"Infinite ammo","italic":false,"color":"dark_aqua"}]'},custom_potion_effects:[{id:"minecraft:blindness",duration:20,show_particles:0b},{id:"minecraft:slowness",duration:40,amplifier:3,show_particles:0b}]} 0
execute if score $Arrows Statues.ItemCount matches 2.. run clear @s tipped_arrow{CustomPotionColor:568831,display:{Name:'[{"text":"Infinite ammo","italic":false,"color":"dark_aqua"}]'},custom_potion_effects:[{id:"minecraft:blindness",duration:20,show_particles:0b},{id:"minecraft:slowness",duration:40,amplifier:3,show_particles:0b}]}
