...
scoreboard players operation $Timer.RemainingSeconds Statues.TempData /= $20 Statues.StaticData
...
function statues:ingame/maps/facade/warptimer_bossbar with storage statues:data
