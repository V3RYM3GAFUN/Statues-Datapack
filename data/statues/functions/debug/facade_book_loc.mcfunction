...
execute as @e[tag=facade_book_pool,type=minecraft:marker] at @s if data block ~ ~ ~ {LootTable:"statues:items/facade/objectives/facade_book_7"} run tag @s add facade_book_haskey
