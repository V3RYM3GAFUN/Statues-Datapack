...
execute as @e[tag=facade_genkey_pool,type=minecraft:marker] at @s if data block ~ ~ ~ {LootTable:"statues:items/facade/objectives/facade_genkey_0"} run tag @s add facade_genkey_haskey
