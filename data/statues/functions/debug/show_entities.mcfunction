...
execute if score dev_show_markers_accurate Statues.FeatureFlags matches 1 as @a[team=Dev] at @s at @e[type=marker,distance=..20] run particle flame ~ ~ ~ 0 0 0 0 1 normal
