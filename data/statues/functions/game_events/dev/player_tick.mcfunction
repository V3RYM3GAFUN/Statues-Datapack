...
execute if score dev_auto_convert_lights Statues.FeatureFlags matches 1 if entity @s[team=Dev] run function statues:ingame/mechanics/lights/create_light_auto
