...
execute if score dev_no_start_requirement Statues.FeatureFlags matches 1.. if score $QueuedCount Statues.DynamicData matches ..0 run tellraw @a {"translate": "statues.pregame.notenough", "color": "red","bold": true}
...
execute unless score dev_no_start_requirement Statues.FeatureFlags matches 1.. if score $QueuedCount Statues.DynamicData matches ..3 run tellraw @a {"translate": "statues.pregame.notenough", "color": "red","bold": true}
execute unless score dev_no_start_requirement Statues.FeatureFlags matches 1.. if score $QueuedCount Statues.DynamicData matches 12.. run tellraw @a {"translate": "statues.pregame.toomany", "color": "red","bold": true}
...
function statues:mechanics/map_vote/choose
