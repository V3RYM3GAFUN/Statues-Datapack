...
execute if score $TutorialKey Statues.ItemCount matches 2.. run give @s iron_ingot[custom_name='[{"text":"Tutorial Key","italic":false}]',custom_model_data=1,custom_data={tutorial_key:1b}]
