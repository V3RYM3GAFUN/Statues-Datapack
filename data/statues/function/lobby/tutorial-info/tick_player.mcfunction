...
execute if score $TutorialKey Statues.ItemCount matches 2.. run give @s iron_ingot[custom_name='[{"translate":"statues.tutorial.key","italic":false}]',custom_model_data={strings:["key_v2"]},custom_data={tutorial_key:1b}]
