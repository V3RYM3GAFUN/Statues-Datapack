...
item replace entity @s armor.chest with leather_chestplate[unbreakable={show_in_tooltip:0b},item_name='[{"translate":"statues.item.gunner.outfit","italic":false,"color":"dark_green","bold":true}]',dyed_color={rgb:8439583,show_in_tooltip:0b},trim={pattern:"silence",material:"emerald"},enchantments={show_in_tooltip:false,levels:{binding_curse:1}},enchantment_glint_override=0b]
item replace entity @s armor.legs with leather_leggings[unbreakable={show_in_tooltip:0b},item_name='[{"translate":"statues.item.gunner.outfit","italic":false,"color":"dark_green","bold":true}]',dyed_color={rgb:8439583,show_in_tooltip:0b},trim={pattern:"wayfinder",material:"emerald"},enchantments={show_in_tooltip:false,levels:{binding_curse:1}},enchantment_glint_override=0b]
item replace entity @s armor.feet with leather_boots[unbreakable={show_in_tooltip:0b},item_name='[{"translate":"statues.item.gunner.outfit","italic":false,"color":"dark_green","bold":true}]',dyed_color={rgb:8439583,show_in_tooltip:0b},trim={pattern:"ward",material:"emerald"},enchantments={show_in_tooltip:false,levels:{binding_curse:1}},enchantment_glint_override=0b]
