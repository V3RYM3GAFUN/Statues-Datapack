...
item replace entity @s armor.head with player_head[item_name='{"translate":"statues.item.trapper.helmet"}',profile={id:[I;14048913,-651933933,-1852222465,-1836681993],properties:[{name:"textures",value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvMzFlNTViYWJmMWU3NWM5Y2ZkM2Q4ODc1YTRmMTcyNzNhMDE0YjhmYTc2OGMzNWM0N2VlYWI2N2MzMjg0OTBkMSJ9fX0="}]}]

item replace entity @s hotbar.4 with minecraft:blaze_rod[use_cooldown={seconds:210},consumable={animation:bow,consume_seconds:0.01,has_consume_particles:false,sound:"minecraft:block.conduit.deactivate"},custom_model_data={strings:["emp_shock"]},item_name='{"translate":"statues.item.trapper.ability.name","italic":false,"color":"gray"}',lore=['[{"translate":"statues.item.trapper.ability.lore.line1","italic":false}]','[{"translate":"statues.item.trapper.ability.lore.line2","italic":false}]','[{"translate":"statues.item.medic.ability.lore.line2","italic":false}]','[{"translate":"statues.item.cooldown","with":[{"translate":"statues.text.3m30s"}]}]']]
