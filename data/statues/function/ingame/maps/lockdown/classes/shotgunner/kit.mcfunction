...
item replace entity @s armor.head with player_head[item_name='{"translate":"statues.item.shotgunner.helmet","italic":false,"color":"gold","bold":true}',profile={id:[I;1019336178,-662092771,-1479134873,-1609012075],properties:[{name:"textures",value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZGUyY2E1NWIzNDZiNjljNjJiNzI4N2Y5MDlmNGNlOGM5Mjk2MTA1YWZjYjg0MDdmMjBmNzc5NWFlZjc1ODE5YyJ9fX0="}]}]

item replace entity @s hotbar.4 with blaze_rod[use_cooldown={seconds:150},consumable={animation:bow,consume_seconds:0.01,has_consume_particles:false,sound:"block.enchantment_table.use"},custom_model_data={strings:["rapid_fire_shotgun"]},item_name='{"translate":"statues.item.shotgunner.ability.name","italic":false}',lore=['[{"translate":"statues.item.medic.ability.lore.line2","italic":false}]','[{"translate":"statues.item.cooldown","with":[{"translate":"statues.text.2m30s"}]}]']]
