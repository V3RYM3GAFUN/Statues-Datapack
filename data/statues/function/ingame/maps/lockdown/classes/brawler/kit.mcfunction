...
item replace entity @s armor.head with player_head[item_name='{"translate":"statues.item.brawler.helmet","color": "red","italic": false,"bold": true}',profile={properties:[{name: "textures",value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvYWVkZmRhNmVmMGYxNWNhOWY4YWM4ZmM1YTE5YWQ3ODEyZDNmYzhhNWZjNzBiNWRhODFhNzFjNTE5ZmYxNmEyMCJ9fX0="}], id: [I; 682621895, 690963283, -1718935196, 100435542]}]
