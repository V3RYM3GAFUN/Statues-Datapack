...
execute if score $Objective Statues.DynamicData matches 7.. if entity @s[tag=!found_key_9] run function statues:ingame/maps/lockdown/on_collect_key with storage statues:map_tick inventory[{components:{"minecraft:custom_data":{item_objective_id:9b}}}].components.minecraft:custom_data
execute if score $Objective Statues.DynamicData matches 7.. if entity @s[tag=!found_key_10] run function statues:ingame/maps/lockdown/on_collect_key with storage statues:map_tick inventory[{components:{"minecraft:custom_data":{item_objective_id:10b}}}].components.minecraft:custom_data
execute if score $Objective Statues.DynamicData matches 8.. if entity @s[tag=!found_key_11] run function statues:ingame/maps/lockdown/on_collect_key with storage statues:map_tick inventory[{components:{"minecraft:custom_data":{item_objective_id:11b}}}].components.minecraft:custom_data
execute if score $Objective Statues.DynamicData matches 8.. if entity @s[tag=!found_key_12] run function statues:ingame/maps/lockdown/on_collect_key with storage statues:map_tick inventory[{components:{"minecraft:custom_data":{item_objective_id:12b}}}].components.minecraft:custom_data
execute if score $Objective Statues.DynamicData matches 8.. if entity @s[tag=!found_key_13] run function statues:ingame/maps/lockdown/on_collect_key with storage statues:map_tick inventory[{components:{"minecraft:custom_data":{item_objective_id:13b}}}].components.minecraft:custom_data
execute if score $Objective Statues.DynamicData matches 9.. if entity @s[tag=!found_key_14] run function statues:ingame/maps/lockdown/on_collect_key with storage statues:map_tick inventory[{components:{"minecraft:custom_data":{item_objective_id:14b}}}].components.minecraft:custom_data
execute if score $Objective Statues.DynamicData matches 9.. if entity @s[tag=!found_key_15] run function statues:ingame/maps/lockdown/on_collect_key with storage statues:map_tick inventory[{components:{"minecraft:custom_data":{item_objective_id:15b}}}].components.minecraft:custom_data
execute if score $Objective Statues.DynamicData matches 9.. if entity @s[tag=!found_key_16] run function statues:ingame/maps/lockdown/on_collect_key with storage statues:map_tick inventory[{components:{"minecraft:custom_data":{item_objective_id:16b}}}].components.minecraft:custom_data
execute if score $Objective Statues.DynamicData matches 9.. if entity @s[tag=!found_key_17] run function statues:ingame/maps/lockdown/on_collect_key with storage statues:map_tick inventory[{components:{"minecraft:custom_data":{item_objective_id:17b}}}].components.minecraft:custom_data
execute if score $Objective Statues.DynamicData matches 9.. if entity @s[tag=!found_key_18] run function statues:ingame/maps/lockdown/on_collect_key with storage statues:map_tick inventory[{components:{"minecraft:custom_data":{item_objective_id:18b}}}].components.minecraft:custom_data
