...
# Cooldown
# execute if score @s Statues.Players matches 1..1800 run item replace entity @s hotbar.4 with carrot_on_a_stick[unbreakable={show_in_tooltip:0b},custom_name='[{"text":"Anchor shoes","italic":false,"color":"red"}]',lore=['[{"text":"Makes you immune to damage","italic":false}]','[{"text":"for 5 seconds, allowing to attack monsters.","italic":false}]','[{"text":"Cooldown: 85 secs","italic":false}]'],custom_data={custom_model_data:2}]
...
function statues:mechanics/xp_bar/from_cooldown { max: 1800 }

#> Enchant the ability item back after a 60 seconds cooldown
# execute if score @s Statues.Players matches ..0 run item replace entity @s hotbar.4 with carrot_on_a_stick[unbreakable={show_in_tooltip:0b},enchantment_glint_override=1b,custom_name='[{"text":"Anchor shoes","italic":false,"color":"red"}]',lore=['[{"text":"Makes you immune to knockback","italic":false}]','[{"text":"for 5 seconds, allowing to attack monsters.","italic":false}]','[{"text":"Cooldown: 85 secs","italic":false}]'],custom_data={custom_model_data:2}]
