...
item replace entity @s hotbar.4 with blaze_rod[use_cooldown={seconds:90},consumable={animation:bow,consume_seconds:0.01,has_consume_particles:false,sound:"block.anvil.place"},custom_model_data={strings:["brawler_ability"]},item_name='{"translate":"statues.item.brawler.ability.name","italic":false,"color":"dark_purple"}',lore=['[{"translate":"statues.item.brawler.ability.lore.line1","italic":false}]','[{"translate":"statues.item.brawler.ability.lore.line2","italic":false}]','[{"translate":"statues.item.cooldown","with":[{"translate":"statues.text.90sec"}]}]'],custom_data={"brawler_ability":true}]
