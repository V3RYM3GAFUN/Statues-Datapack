...
loot replace entity @s hotbar.0 loot statues:items/classes/shotgunner/shotgun_raycast
...
item replace entity @s hotbar.4 with blaze_rod[use_cooldown={seconds:150},consumable={animation:bow,consume_seconds:0.01,has_consume_particles:false,sound:"block.enchantment_table.use"},custom_model_data={strings:["rapid_fire_shotgun"]},item_name='{"translate":"statues.item.shotgunner.ability.name","italic":false}',lore=['[{"translate":"statues.item.medic.ability.lore.line2","italic":false}]','[{"translate":"statues.item.cooldown.min","with":[{"text":"2"},{"text": "30"}]}]'],item_model="statues:weapons/survivors/shotgun",custom_data={"shotgunner_ability":true}]
