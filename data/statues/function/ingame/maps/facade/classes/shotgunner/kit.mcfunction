...
item replace entity @s armor.head with player_head[custom_name='{"translate":"statues.item.shotgunner.helmet"}',profile={id:[I;1246757609,-563001642,-2058751332,-311473162],properties:[{name:"textures",value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvMjhmZTU5MzViMmIzMjAyOWZiODY2ZTFhOTY2ODNmOWI4MDhkMzVkZDljZDNhNzY5NDU1MzRkYmQwZWM0MWNhOSJ9fX0="}]}]
...
item replace entity @s armor.chest with leather_chestplate[unbreakable={show_in_tooltip:0b},custom_name='[{"translate":"statues.item.shotgunner.oufit","italic":false,"color":"gold","bold":true}]',dyed_color={rgb:16701501,show_in_tooltip:0b}]
item replace entity @s armor.legs with leather_leggings[unbreakable={show_in_tooltip:0b},custom_name='[{"translate":"statues.item.shotgunner.oufit","italic":false,"color":"gold","bold":true}]',dyed_color={rgb:16701501,show_in_tooltip:0b}]
item replace entity @s armor.feet with leather_boots[unbreakable={show_in_tooltip:0b},custom_name='[{"translate":"statues.item.shotgunner.oufit","italic":false,"color":"gold","bold":true}]',dyed_color={rgb:16701501,show_in_tooltip:0b}]
