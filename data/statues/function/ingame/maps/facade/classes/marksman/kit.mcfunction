...
item replace entity @s armor.chest with leather_chestplate[unbreakable={show_in_tooltip:0b},custom_name='[{"translate":"statues.item.marksman.outfit","italic":false,"color":"#666666","bold":true}]',dyed_color={rgb:1908001,show_in_tooltip:0b},trim={pattern:"tide",material:"gold"}]
item replace entity @s armor.legs with leather_leggings[unbreakable={show_in_tooltip:0b},custom_name='[{"translate":"statues.item.marksman.outfit","italic":false,"color":"#666666","bold":true}]',dyed_color={rgb:1908001,show_in_tooltip:0b},trim={pattern:"sentry",material:"gold"}]
item replace entity @s armor.feet with leather_boots[unbreakable={show_in_tooltip:0b},custom_name='[{"translate":"statues.item.marksman.outfit","italic":false,"color":"#666666","bold":true}]',dyed_color={rgb:1908001,show_in_tooltip:0b},trim={pattern:"host",material:"gold"}]
