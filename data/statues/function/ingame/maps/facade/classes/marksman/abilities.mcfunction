...
execute if score @s Statues.Players matches 4200 run effect give @s glowing 6 0 true
execute if score @s Statues.Players matches 4200 run effect give @e[team=Monster] glowing 12 0 true
execute if score @s Statues.Players matches 4200 run tellraw @a [{"selector":"@s"},{"text":" used an X-ray on the monsters!"}]
