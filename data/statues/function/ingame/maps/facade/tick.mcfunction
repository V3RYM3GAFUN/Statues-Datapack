...
#> Objective tracking
# Backup genkey
execute as @a if score $Objective Statues.DynamicData matches 0 unless entity @s[team=!Survivor,tag=!dev_always_show_floor_objective] run title @s actionbar {"translate":"statues.text.facade.objective.actionbar.0","color":"aqua","with": [{"translate":"statues.text.objective","color": "white","bold":true}]}
execute as @a if score $Objective Statues.DynamicData matches 1 unless entity @s[team=!Survivor,tag=!dev_always_show_floor_objective] run title @s actionbar {"translate":"statues.text.facade.objective.actionbar.1","color":"aqua","with": [{"translate":"statues.text.objective","color": "white","bold":true}]}
# Backup Power
execute as @a if score $Objective Statues.DynamicData matches 2 unless entity @s[team=!Survivor,tag=!dev_always_show_floor_objective] run title @s actionbar {"translate":"statues.text.facade.objective.actionbar.2","color":"aqua","with": [{"translate":"statues.text.objective","color": "white","bold":true}]}
# Labkey
execute as @a if score $Objective Statues.DynamicData matches 3 unless entity @s[team=!Survivor,tag=!dev_always_show_floor_objective] run title @s actionbar {"translate":"statues.text.facade.objective.actionbar.3","color":"aqua","with": [{"translate":"statues.text.objective","color": "white","bold":true}]}
execute as @a if score $Objective Statues.DynamicData matches 4 unless entity @s[team=!Survivor,tag=!dev_always_show_floor_objective] run title @s actionbar {"translate":"statues.text.facade.objective.actionbar.4","color":"aqua","with": [{"translate":"statues.text.objective","color": "white","bold":true}]}
# Override
execute as @a if score $Objective Statues.DynamicData matches 5 unless entity @s[team=!Survivor,tag=!dev_always_show_floor_objective] run title @s actionbar {"translate":"statues.text.facade.objective.actionbar.5","color":"aqua","with": [{"translate":"statues.text.objective","color": "white","bold":true}]}
# Main Power
execute as @a if score $Objective Statues.DynamicData matches 6 unless entity @s[team=!Survivor,tag=!dev_always_show_floor_objective] run title @s actionbar {"translate":"statues.text.facade.objective.actionbar.6","color":"aqua","with": [{"translate":"statues.text.objective","color": "white","bold":true}]}
# High Class Key
execute as @a if score $Objective Statues.DynamicData matches 7 unless entity @s[team=!Survivor,tag=!dev_always_show_floor_objective] run title @s actionbar {"translate":"statues.text.facade.objective.actionbar.7","color":"aqua","with": [{"translate":"statues.text.objective","color": "white","bold":true}]}
execute as @a if score $Objective Statues.DynamicData matches 8 unless entity @s[team=!Survivor,tag=!dev_always_show_floor_objective] run title @s actionbar {"translate":"statues.text.facade.objective.actionbar.8","color":"aqua","with": [{"translate":"statues.text.objective","color": "white","bold":true}]}
# Book
execute as @a if score $Objective Statues.DynamicData matches 9 unless entity @s[team=!Survivor,tag=!dev_always_show_floor_objective] run title @s actionbar {"translate":"statues.text.facade.objective.actionbar.9","color":"aqua","with": [{"translate":"statues.text.objective","color": "white","bold":true}]}
# Escape
execute as @a if score $Objective Statues.DynamicData matches 10 unless entity @s[team=!Survivor,tag=!dev_always_show_floor_objective] run title @s actionbar {"translate":"statues.text.facade.objective.actionbar.10","color":"aqua","with": [{"translate":"statues.text.objective","color": "white","bold":true}]}
execute as @a if score $Objective Statues.DynamicData matches 11 unless entity @s[team=!Survivor,tag=!dev_always_show_floor_objective] run title @s actionbar {"translate":"statues.text.facade.objective.actionbar.11","color":"aqua","with": [{"translate":"statues.text.objective","color": "white","bold":true}]}
