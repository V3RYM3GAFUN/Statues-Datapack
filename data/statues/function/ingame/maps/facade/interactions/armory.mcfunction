...
execute on target if predicate statues:holding_facade_armory run tellraw @a[team=!Monster] [{"translate":" has unlocked the armory!","color":"aqua","with": [{"bold":true,"selector":"@s"}]}]
