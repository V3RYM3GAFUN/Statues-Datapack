...
execute on target if predicate statues:holding_facade_armory run tellraw @a[team=!Monster] [{"translate":"statues.game.facade.objective.armory.unlock","color":"aqua","with": [{"bold":true,"selector":"@s"}]}]
