...
execute as @a[scores={Statues.Monsters=4}] run item replace entity @s hotbar.4 with tipped_arrow[custom_name='[{"text":"Insects","italic":false,"color":"#006633","bold":true}]',potion_contents={custom_color:2325012,custom_effects:[{id:"minecraft:poison",duration:60,amplifier:1,show_particles:0b,show_icon:0b},{id:"minecraft:instant_health",duration:1,amplifier:0,show_particles:0b,show_icon:0b}]}]
