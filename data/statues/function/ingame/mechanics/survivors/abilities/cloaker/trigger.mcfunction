...
give @s blaze_rod[use_cooldown={seconds:30},consumable={animation:bow,consume_seconds:0.01,has_consume_particles:false,sound:"entity.enderman.teleport"},custom_model_data={strings:[""]},custom_name='{"translate":"statues.item.cloaker.ability.name","italic":false,"color":"dark_purple"}',lore=['[{"translate":"statues.item.cooldown.sec","with":[{"text":"30"}]}]']]
