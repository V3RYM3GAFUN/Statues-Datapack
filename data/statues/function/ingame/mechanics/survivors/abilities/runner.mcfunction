...
give @s blaze_rod[use_cooldown={seconds:300},consumable={animation:bow,consume_seconds:0.01,has_consume_particles:false,sound:"entity.bat.takeoff"},item_name='{"translate":"statues.item.runner.ability.name","italic":false,"color":"aqua"}',lore=['[{"translate":"statues.item.runner.ability.lore.line1","italic":false}]','[{"translate":"statues.item.runner.ability.lore.line2","italic":false}]','[{"translate":"statues.item.cooldown.min","with":[{"text":"5"},{"text": "0"}]}]'],item_model="statues:survivors/abilities/dopamine",custom_data={"runner_ability":true}]
