...
execute if items entity @s weapon *[custom_data~{medic_gun:true}] run return run function statues:ingame/mechanics/raycasting/shoot_sniper_ammo/reset/medic {hand:"mainhand"}
