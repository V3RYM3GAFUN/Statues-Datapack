...
give @s stick[consumable={animation:bow,consume_seconds:0.01,has_consume_particles:false,sound:"minecraft:ui.button.click"},item_model="statues:weapons/survivors/sniper",use_cooldown={seconds:1,cooldown_group:"bow"},custom_data={"is_sniper":true,ammo_select:2b},item_name='[{"translate":"statues.item.sniper","bold":true,"color":"red"},{"text":" : "},{"translate":"statues.item.medic.arrow","bold":false}]']
