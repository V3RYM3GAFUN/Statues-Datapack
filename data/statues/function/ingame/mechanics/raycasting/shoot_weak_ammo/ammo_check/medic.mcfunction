...
execute if items entity @s weapon *[custom_data~{is_medic_gun:true}] run return run function statues:ingame/mechanics/raycasting/shoot_weak_ammo/reset/medic {hand:"mainhand"}
