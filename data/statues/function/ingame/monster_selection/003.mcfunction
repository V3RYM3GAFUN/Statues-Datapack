...
item replace entity @s weapon.mainhand with red_dye[custom_name='[{"text":"Boxing glove","italic":false,"color":"red","bold":true}]',custom_model_data={strings:["boxing_glove"]}] 1
