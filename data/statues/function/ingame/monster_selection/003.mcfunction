...
item replace entity @s hotbar.0 with red_dye[custom_name='[{"text":"Boxing glove","italic":false,"color":"red","bold":true}]',item_model="stuates:weapons/monsters/boxing_glove"] 1
item replace entity @s weapon.offhand with red_dye[custom_name='[{"text":"Boxing glove","italic":false,"color":"red","bold":true}]',item_model="stuates:weapons/monsters/boxing_glove"] 1
