...
item replace entity @s armor.head with stick[custom_model_data=4]
item replace entity @s weapon.mainhand with trident[unbreakable={show_in_tooltip:0b},enchantments={levels:{loyalty:3},show_in_tooltip:0b},custom_name='[{"text":"Tentacle","italic":false,"color":"dark_red","bold":true}]',custom_model_data=1] 1
item replace entity @s weapon.offhand with trident[unbreakable={show_in_tooltip:0b},enchantments={levels:{loyalty:3},show_in_tooltip:0b},custom_name='[{"text":"Tentacle","italic":false,"color":"dark_red","bold":true}]',custom_model_data=1]
