...
item replace entity @s armor.head with stick[item_model="statues:monsters/elephant",custom_name='{"translate": "statues.item.001.head","color": "dark_gray","bold": true,"italic": false}']
item replace entity @s hotbar.0 with trident[unbreakable={show_in_tooltip:0b},enchantments={levels:{loyalty:3},show_in_tooltip:0b},custom_name='[{"translate":"statues.item.001.weapon","italic":false,"color":"dark_red","bold":true}]',item_model="statues:weapons/monsters/tentacle"] 1
item replace entity @s weapon.offhand with trident[unbreakable={show_in_tooltip:0b},enchantments={levels:{loyalty:3},show_in_tooltip:0b},custom_name='[{"translate":"statues.item.001.weapon","italic":false,"color":"dark_red","bold":true}]',item_model="statues:weapons/monsters/tentacle"]
