...
item replace entity @s weapon.mainhand with crossbow[unbreakable={},enchantments={multishot:1,quick_charge:1},custom_name='[{"text":"Insect launcher","italic":false,"color":"white","bold":true}]',custom_model_data=4] 1
