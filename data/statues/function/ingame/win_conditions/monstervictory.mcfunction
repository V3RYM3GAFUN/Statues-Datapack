...
execute if score $Map Statues.DynamicData matches 0 run advancement grant @a[team=Monster] only statues:game/maps/facade/win_as_monster
execute if score $Map Statues.DynamicData matches 1 run advancement grant @a[team=Monster] only statues:game/maps/lockdown/win_as_monster
