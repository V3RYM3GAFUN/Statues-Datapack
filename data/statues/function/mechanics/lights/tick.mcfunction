...
#> 3x5x3 detection box
execute at @a[gamemode=!spectator,x=0] positioned ~-2 ~ ~-2 as @e[type=minecraft:block_display,tag=game_lamp,dx=2,dy=4,dz=2] at @s positioned ~0.5 ~ ~0.5 run function statues:mechanics/lights/summon_collision