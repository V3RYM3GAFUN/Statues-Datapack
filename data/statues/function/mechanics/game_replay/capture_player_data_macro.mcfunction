...
$execute store success score $CommandSuccess Statues.TempData run data modify storage statues:game_replay current_replay.player_data[$(index)].position set from entity @s Pos
...
execute if score $CommandSuccess Statues.TempData matches 1 run data modify storage statues:game_replay current_replay.current_frame[-1].content.position set from entity @s Pos

$execute store success score $CommandSuccess Statues.TempData run data modify storage statues:game_replay current_replay.player_data[$(index)].rotation set from entity @s Rotation
...
execute if score $CommandSuccess Statues.TempData matches 1 run data modify storage statues:game_replay current_replay.current_frame[-1].content.rotation set from entity @s Rotation
...
data modify storage statues:game_replay item set from entity @s SelectedItem
...
data modify storage statues:game_replay item set value {}
data modify storage statues:game_replay item set from entity @s Inventory[{Slot:-106b}]
...
data modify storage statues:game_replay item set value {}
data modify storage statues:game_replay item set from entity @s Inventory[{Slot:103b}]
...
data modify storage statues:game_replay item set value {}
data modify storage statues:game_replay item set from entity @s Inventory[{Slot:102b}]
...
data modify storage statues:game_replay item set value {}
data modify storage statues:game_replay item set from entity @s Inventory[{Slot:101b}]
...
data modify storage statues:game_replay item set value {}
data modify storage statues:game_replay item set from entity @s Inventory[{Slot:100b}]
