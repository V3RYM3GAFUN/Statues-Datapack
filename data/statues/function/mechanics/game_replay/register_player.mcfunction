...
execute in minecraft:overworld run loot insert 0 -60 0 loot statues:game_replay/player_head
execute in minecraft:overworld run data modify storage statues:game_replay new_player_object.username set from block 0 -60 0 Items[{id:"minecraft:player_head"}].components."minecraft:profile".name
