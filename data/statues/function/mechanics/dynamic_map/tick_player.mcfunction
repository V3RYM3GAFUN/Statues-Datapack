...
execute unless score @s Statues.DynamicMapIdGiven matches 0.. run scoreboard players set @s Statues.DynamicMapIdGiven 0
...
execute if score @s Statues.DynamicMapIdGiven = $DynamicMapNew Statues.DynamicMapIdGiven run return 1
