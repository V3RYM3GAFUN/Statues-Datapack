...
execute if entity @a[team=Monster,distance=12.5..16.5,sort=nearest,limit=1] if score @s Statues.Heartbeat matches ..0 run playsound block.note_block.basedrum master @s ~ ~ ~ 1 0
...
execute if entity @a[team=Monster,distance=6.5..12.4999,sort=nearest,limit=1] if score @s Statues.Heartbeat matches ..0 run playsound block.note_block.basedrum master @s ~ ~ ~ 1 0.65
execute if score @s Statues.Heartbeat matches ..-1 run scoreboard players add @s Statues.Heartbeat 40
execute if score @s Statues.Heartbeat matches ..0 run scoreboard players set @s Statues.Heartbeat 0
...
execute if entity @a[team=Monster,distance=0..6.4999,sort=nearest,limit=1] if score @s Statues.Heartbeat matches ..0 run playsound block.note_block.basedrum master @s ~ ~ ~ 1 0.95
execute if score @s Statues.Heartbeat matches ..-1 run scoreboard players add @s Statues.Heartbeat 40
execute if score @s Statues.Heartbeat matches ..0 run scoreboard players set @s Statues.Heartbeat 0
