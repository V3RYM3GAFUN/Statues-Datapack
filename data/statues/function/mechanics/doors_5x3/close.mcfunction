...
playsound statues:game.door.large.close block @a ~ ~ ~ 1 0.85
...
execute as @s[y_rotation=0] run fill ~2 ~2 ~ ~-2 ~ ~ gray_stained_glass_pane replace air
execute as @s[y_rotation=90] run fill ~ ~2 ~2 ~ ~ ~-2 gray_stained_glass_pane replace air
