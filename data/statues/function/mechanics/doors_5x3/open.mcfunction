...
playsound statues:game.door.large.open block @a ~ ~ ~ 1 0.85
...
execute as @s[y_rotation=0] run fill ~2 ~2 ~ ~-2 ~ ~ air replace gray_stained_glass_pane
execute as @s[y_rotation=90] run fill ~ ~2 ~2 ~ ~ ~-2 air replace gray_stained_glass_pane
