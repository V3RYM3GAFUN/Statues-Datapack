...
execute if score $IntegrityCheckStairs Statues.VentData matches 1 run function statues:mechanics/vents/integrity_error_message_stairs_macro with storage statues:data stairs_integrity
