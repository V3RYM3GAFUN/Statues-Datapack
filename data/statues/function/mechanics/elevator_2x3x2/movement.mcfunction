...
$execute if score $SoundTick Statues.TempData matches 0 positioned ~ ~$(elevator_location_cur) ~ run function statues:mechanics/elevator_2x3x2/sound_tick
...
function statues:mechanics/elevator_2x3x2/apply_collision_movement_relative with storage statues:data

execute if score @s Statues.ElevatorRemaining matches 0 run function statues:mechanics/elevator_2x3x2/post_movement with storage statues:data
