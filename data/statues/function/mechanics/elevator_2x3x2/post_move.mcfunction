...
$execute positioned ~ ~$(elevator_location_to) ~ as @e[tag=elevator_door,sort=nearest,limit=1] at @s run function statues:mechanics/elevator_2x3x2/door_open with entity @s data
