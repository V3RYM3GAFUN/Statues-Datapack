...
function statues:mechanics/elevator_2x3x2/update_lights with storage statues:data
...
function statues:mechanics/elevator_2x3x2/post_movement with storage statues:data
