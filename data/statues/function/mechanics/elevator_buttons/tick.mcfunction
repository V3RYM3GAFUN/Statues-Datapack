...
$execute unless score $(elevator) Statues.ElevatorState matches 0 run return 0
function statues:utils/button_crimson_to_warped
$execute as $(elevator) unless entity @s[tag=!elevator_room_3x3x3,tag=!elevator_room_2x3x2,tag=!elevator_room_freight] run scoreboard players set @s Statues.ElevatorTo $(elevator_y)
$execute as $(elevator) unless entity @s[tag=!elevator_room_3x3x3,tag=!elevator_room_2x3x2,tag=!elevator_room_freight] run scoreboard players set @s Statues.ElevatorState 1
