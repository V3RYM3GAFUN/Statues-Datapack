...
function statues:mechanics/elevator_3x3x3/apply_collision_movement_align
execute store result storage statues:data elevator_location int 1 run scoreboard players get @s Statues.ElevatorFrom
function statues:mechanics/elevator_3x3x3/update_lights with storage statues:data
...
function statues:mechanics/elevator_3x3x3/post_movement with storage statues:data
