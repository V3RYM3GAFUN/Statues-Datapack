...
execute store result storage statues:temp iter_exec.index int 1 run scoreboard players get $IterationsRemaining Statues.TempData
execute if score $IterationsRemaining Statues.TempData matches 1.. run function statues:mechanics/location_markers/load_type_iter_exec with storage statues:temp iter_exec
...
execute if score $IterationsRemaining Statues.TempData matches 1.. run function statues:mechanics/location_markers/load_type_iter
