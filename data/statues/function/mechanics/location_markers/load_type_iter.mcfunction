...
function statues:mechanics/location_markers/load_type_iter_exec with storage statues:temp macro_exec
scoreboard players remove $LocationMarkersRemaining Statues.DynamicData 1
function statues:mechanics/location_markers/load_type_iter