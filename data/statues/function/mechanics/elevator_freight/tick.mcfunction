...
execute unless entity @s[tag=elevator_room_freight_gencol] align xyz positioned ~0.5 ~ ~0.5 run function statues:mechanics/elevator_freight/generate_collisions
...
execute if score @s Statues.ElevatorState matches 3..4 run function statues:mechanics/elevator_freight/calculate_moving_location
...
function statues:mechanics/elevator_freight/elevator_tick with storage statues:data
execute if score @s Statues.ElevatorState matches 1 run function statues:mechanics/elevator_freight/pre_move with storage statues:data
execute if score @s Statues.ElevatorState matches 2 run function statues:mechanics/elevator_freight/pre_movement with storage statues:data
execute if score @s Statues.ElevatorState matches 3..4 run function statues:mechanics/elevator_freight/movement with storage statues:data
execute if score @s Statues.ElevatorState matches 5 run function statues:mechanics/elevator_freight/post_move with storage statues:data
execute if score @s Statues.ElevatorState matches 6 run function statues:mechanics/elevator_freight/cooldown
