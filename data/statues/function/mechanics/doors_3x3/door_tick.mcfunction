...
execute at @s[y_rotation=0] unless entity @e[tag=3x3left,distance=..2] align xyz run summon item_display ~.5 ~.5 ~.5 {item:{Count:1b,tag:{CustomModelData:8},id:"minecraft:stick"},Tags:["3x3display","3x3left"],Rotation:[180f,0f]}
...
execute at @s[y_rotation=90] unless entity @e[tag=3x3left,distance=..2] align xyz run summon item_display ~.5 ~.5 ~.5 {item:{Count:1b,tag:{CustomModelData:8},id:"minecraft:stick"},Tags:["3x3display","3x3left"],Rotation:[-90f,0f]}
execute at @s[y_rotation=90] unless entity @e[tag=3x3right,distance=..2] align xyz run summon item_display ~.5 ~.5 ~.5 {item:{Count:1b,tag:{CustomModelData:9},id:"minecraft:stick"},Tags:["3x3display","3x3right"],Rotation:[90f,0f]}