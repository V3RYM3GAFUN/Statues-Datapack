...
playsound statues:game.door.large.close block @a ~ ~ ~ 1 1
...
execute as @s[y_rotation=0] run fill ~1 ~1 ~ ~-1 ~-1 ~ gray_stained_glass_pane replace air
execute as @s[y_rotation=90] run fill ~ ~1 ~1 ~ ~-1 ~-1 gray_stained_glass_pane replace air
