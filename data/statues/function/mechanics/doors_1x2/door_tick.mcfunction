...
execute at @s[y_rotation=0] align xyz positioned ~-1 ~-.5 ~-1 unless entity @e[tag=1x2bottom,dx=2,dy=1,dz=22] align xyz run summon block_display ~1 ~1 ~.6 {block_state:{Name:"minecraft:iron_door",Properties:{half:"lower",hinge:"right"}},Tags:["1x2display","1x2bottom"],Rotation:[0f,0f]}
