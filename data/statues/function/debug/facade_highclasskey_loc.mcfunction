...
execute as @e[tag=facade_highclasskey_pool,type=minecraft:marker] at @s if data block ~ ~ ~ Items[{"component":{"custom_data":{facade_highclass_item:1b}}}] run tag @s add facade_highclasskey_haskey
