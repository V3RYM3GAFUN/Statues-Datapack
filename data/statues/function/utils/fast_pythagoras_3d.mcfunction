...
execute unless score $PythagorasX Statues.TempData matches 0.. run scoreboard players operation $PythagorasX Statues.TempData *= $-1 Statues.Constants
execute unless score $PythagorasY Statues.TempData matches 0.. run scoreboard players operation $PythagorasY Statues.TempData *= $-1 Statues.Constants
execute unless score $PythagorasZ Statues.TempData matches 0.. run scoreboard players operation $PythagorasZ Statues.TempData *= $-1 Statues.Constants
...
scoreboard players operation $PythagorasT Statues.TempData *= $96 Statues.Constants
scoreboard players operation $PythagorasTY Statues.TempData = $PythagorasY Statues.TempData
scoreboard players operation $PythagorasTY Statues.TempData *= $40 Statues.Constants
scoreboard players operation $PythagorasT Statues.TempData += $PythagorasTY Statues.TempData
scoreboard players operation $PythagorasZ Statues.TempData *= $100 Statues.Constants
...
scoreboard players operation $PythagorasR Statues.TempData *= $96 Statues.Constants
scoreboard players operation $PythagorasRY Statues.TempData = $PythagorasZ Statues.TempData
scoreboard players operation $PythagorasRY Statues.TempData *= $40 Statues.Constants
