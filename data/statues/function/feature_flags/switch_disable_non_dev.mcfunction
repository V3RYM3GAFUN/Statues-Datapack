...
execute if score doors Statues.FeatureFlags matches 1.. run function statues:feature_flags/set_doors {value:0}
execute if score doors_1x2 Statues.FeatureFlags matches 1.. run function statues:feature_flags/set_doors_1x2 {value:0}
execute if score doors_2x2 Statues.FeatureFlags matches 1.. run function statues:feature_flags/set_doors_2x2 {value:0}
execute if score doors_3x3 Statues.FeatureFlags matches 1.. run function statues:feature_flags/set_doors_3x3 {value:0}
execute if score dynamic_map Statues.FeatureFlags matches 1.. run function statues:feature_flags/set_dynamic_map {value:0}
execute if score elevator Statues.FeatureFlags matches 1.. run function statues:feature_flags/set_elevator {value:0}
execute if score elevator_2x3x2 Statues.FeatureFlags matches 1.. run function statues:feature_flags/set_elevator_2x3x2 {value:0}
execute if score elevator_3x3x3 Statues.FeatureFlags matches 1.. run function statues:feature_flags/set_elevator_3x3x3 {value:0}
execute if score elevator_buttons Statues.FeatureFlags matches 1.. run function statues:feature_flags/set_elevator_buttons {value:0}
execute if score elevator_freight Statues.FeatureFlags matches 1.. run function statues:feature_flags/set_elevator_freight {value:0}
execute if score flashlight Statues.FeatureFlags matches 1.. run function statues:feature_flags/set_flashlight {value:0}
execute if score floors Statues.FeatureFlags matches 1.. run function statues:feature_flags/set_floors {value:0}
execute if score game_replay Statues.FeatureFlags matches 1.. run function statues:feature_flags/set_game_replay {value:0}
execute if score hiding Statues.FeatureFlags matches 1.. run function statues:feature_flags/set_hiding {value:0}
...
execute if score sas Statues.FeatureFlags matches 1.. run function statues:feature_flags/set_sas {value:0}
