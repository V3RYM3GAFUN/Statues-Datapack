...
execute if entity @e[limit=1,tag=ff_err_source] run tellraw @a[tag=dev_see_feature_flag_failed_uses] [{"color":"red","text":"Tried to use "},{"text":"Elevator Buttons","color":"aqua","italic":true,"hoverEvent":{"action":"show_text","value":"Click to enable the feature flag"},"clickEvent":{"action":"run_command","value":"/function statues:feature_flags/set_elevator_buttons {value:1}"}},{"text":" specific function while the feature is disabled."},{"text":" Source: ","italic":true},{"selector":"@e[tag=ff_err_source]","italic":true}]
execute unless entity @e[limit=1,tag=ff_err_source] run tellraw @a[tag=dev_see_feature_flag_failed_uses] [{"color":"red","text":"Tried to use "},{"text":"Elevator Buttons","color":"aqua","italic":true,"hoverEvent":{"action":"show_text","value":"Click to enable the feature flag"},"clickEvent":{"action":"run_command","value":"/function statues:feature_flags/set_elevator_buttons {value:1}"}},{"text":" specific function while the feature is disabled."},{"text":" Source: Server","italic":true}]
